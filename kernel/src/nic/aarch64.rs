...
/// AArch64 UEFI app calls [`set_allow_virtio_mmio_scan`] (VM-like firmware vendor match and/or
/// NVRAM `EveVirtioMmioScan`) before the first [`crate::arm_run::main_step`].
