...
#
# Output: tools/syslinux-bios/{isolinux.bin,ldlinux.c32,libcom32.c32,libutil.c32,memdisk,isohdpfx.bin,mboot.c32,mbr.bin}
...
tar -xzf "$TMP/$ARCHIVE" -C "$TMP" \
  ...
  "${PREFIX}/bios/com32/mboot/mboot.c32" \
  "${PREFIX}/bios/memdisk/memdisk" \
  "${PREFIX}/bios/mbr/isohdpfx.bin" \
  "${PREFIX}/bios/mbr/mbr.bin"
...
cp -f "$TMP/${PREFIX}/bios/com32/mboot/mboot.c32" "$DEST/mboot.c32"
cp -f "$TMP/${PREFIX}/bios/mbr/mbr.bin" "$DEST/mbr.bin"
